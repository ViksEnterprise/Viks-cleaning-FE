...
export default function Contact() {
  return (
    <div>
      <div className="bg-[url('/img/contact.jpg')] w-full lg:h-screen sm:h-full h-svh bg-no-repeat bg-cover bg-center relative before:bg-black/55 before:h-full before:w-full before:absolute before:z-1 text-white flex items-center justify-center">
