...
export default function Contact() {
  return (
    <div>
      <div className="bg-[url('/img/contact.jpg')] w-full h-screen bg-no-repeat bg-cover bg-center relative before:bg-black/55 before:h-full before:w-full before:absolute before:z-1 text-white flex items-center justify-center">
        <h2 className="relative z-2 text-5xl font-semibold uppercase">
          Contact us
        </h2>
      </div>
      <div className="flex items-center justify-center w-full py-5">
        <div className="p-5 w-6xl flex items-center gap-4 h-fit justify-between">
          <form
            method="post"
          ...
          <div className="h-118 flex relative bg-black before:content-[' '] before:absolute before:bg-black before:h-full before:w-[0.5px] before:z-1 before:flex"></div>
